...
export default function Home() {
  ...
  <div className="max-w-4xl mx-auto space-y-12"> 
    ...
    <section className="w-full">
      <h2 className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.3em] mb-4 flex items-center gap-2">
        <span className="w-8 h-px bg-zinc-800"></span> 01. Personnel Intake
      </h2>
